...
- A pull request comment can also trigger a dev deploy from the PR head branch:
  ```text
...
- A small technical PR can be used to verify the comment-driven deploy flow before merge.
